...
1000 本完全可以**作为小图书馆**查找使用，给这个仓库点个 `star` 防止下次想看却找不到。

## 推荐下载

这么多书或许你找不到重点，我按照编程学习经验，给你精心挑选了 **50 本精华书籍**，都是我在学习过程中收集，**书不在多贵在精**。

![](https://cdn.jsdelivr.net/gh/lemonchann/images/gzh/解压密码引导.png)

下载地址：https://pan.baidu.com/s/1HuFPF2dJDx-QhWwTTE6seA

提取码：8whk

解压密码：防止资源失效，关注公众号：**后端技术学堂**，回复「**解压密码**」获取。
